window.onload = function() {
	...
	var game_menus = document.querySelector('#game_menu');
	var victory = document.getElementById('victory');
	var victory_container = document.getElementById('victory_container');
	var victory_score_container = document.getElementById('victory_score_container');
	var victory_score = document.getElementById('victory_score');
	var victory_exit = document.getElementById('victory_exit');
	var about = document.getElementById('about_game');

	var game_over_ok = document.getElementById('gameOver_ok');
	var game_over_menu = document.getElementById('restart_game');
	...
	//If main game starts run this functions
	function startGame() {
		...
		var rem_missiles = document.getElementById('missiles');
		...
		function alien_boss1() {
			...
			if (boss1_specs.life <= 0) {
				...
				victory.style.transform = 'translate3d(500px, 280px, 0)';
				boss1_specs.x = 700;
				boss1_specs.y = 200;
				gameplay.pause();
				victory.play();

				setTimeout(victory_is_real, 2000);
			}
		}

		function victory_is_real() {
			victory_container.classList.remove('display_none');
			game_container.classList.add('display_none');
			game_over_menu.classList.add('display_none');

			setTimeout(victory_effect, 1000);
			setTimeout(victory_score_effect, 1500);

		}
		function victory_effect() {
			victory_score_container.style.transform = 'translate3d(0, 0, 0)';
		}
		function victory_score_effect() {
			victory_score.style.transform = 'translate3d(0, 0, 0)';
		}
		...
		function moveBoss() { //Boss moves back if reaches 100 px from left
			boss1_specs.x --;
		...
		function boss_evade() { //Boss will follow your Y position every 5 sec.
			setTimeout(function() {
				boss1_specs.y = hero_obj.y -100;
				boss_evade();
			}, 4000);	
		}
		boss_evade();
		...
		function project_score() {
			...
			document.querySelector('#final_score').innerHTML = hero_obj.score;
			document.querySelector('#victory_score').innerHTML = hero_obj.score;
		}
